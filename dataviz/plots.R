...
filename <- paste0("dataviz/plot-", format(Sys.Date(), "%Y-%m-%d"), "_", format(Sys.time(), "%H-%M-%S"), ".png")
ggsave(plot, filename = filename, width = 10, height = 7.5, dpi = 300)
ggsave(plot, filename = "dataviz/plot-latest.png", width = 10, height = 7.5, dpi = 300)
