<x-app-layout>
    ...
    <div class="mna-main-container">
        <div class="mna-main-content mt-8 md:mt-12">
            <x-app-logo />
            <x-lead />
            <p class="mt-6">In Zentrum Lilienberg, einer Grossunterkunft für unbegleitete minderjährige Geflüchtete (MNA), wurden im vergangenen Jahr gravierende Missstände festgestellt: Platzmangel wegen Überbelegung, der überladene Arbeitsalltag und zu wenig geschultes Personal verunmöglichen eine kindgerechte Betreuung der knapp 100 Jugendlichen.</p>
            <p>Eine vom Regierungsrat in Auftrag gegebene externe Untersuchung hielt unmissverständlich fest: <b>Das Kindeswohl der Jugendlichen ist akut gefährdet. Die Untersuchung zeigte, dass die groben Missstände keine Einzelfälle, sondern Folgen des Unterbringungs- und Betreuungssystems sind.</b> Der laufende MNA-Unterbringungsvertrag läuft Ende Februar 2024 aus. Es ist Zeit für einen Neuanfang: Heute wird die Betreuung und Unterbringung von Kindern ohne Fluchterfahrung vom kantonalen Amt für Jugend- und Berufsberatung (AJB) organisiert, jene von MNAs vom kantonalen Sozialamt. Dieses Parallelsystem ist nicht tragbar. Die Unterbringung von MNAs soll in die Angebotsplanung der Kinder- und Jugendhilfe des AJB aufgenommen werden.</p>
            <p><b>Kinder sind in erster Linie Kinder: Für die Betreuung und die Unterbringung von MNAs sollen gleichwertige Standards gelten wie für Kinder und Jugendliche ohne Fluchterfahrung. Zudem müssen die spezifischen Unterstützungsbedürfnisse minderjähriger Geflüchteter berücksichtigt werden.</b></p>
